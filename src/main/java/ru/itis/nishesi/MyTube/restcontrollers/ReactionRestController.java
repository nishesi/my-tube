...
public class ReactionRestController {
    ...
    @PostMapping
    public ResponseEntity<?> createView(@Valid @RequestBody ReactionForm reactionForm,
    ...
    @GetMapping("/{videoId}")
    public ResponseEntity<?> getView(@PathVariable UUID videoId,
                                     @SessionAttribute UserDto user) {
        try {
    ...
    @PutMapping
    public ViewDto updateView(@Valid @RequestBody ReactionForm reactionForm,
                              @SessionAttribute UserDto user) {
        return viewService.updateView(reactionForm, user);
    }

    @DeleteMapping("/{videoId}")
    public ResponseEntity<?> deleteView(@PathVariable UUID videoId,
                                        @SessionAttribute UserDto user) {
